...
@interface Config {
	...
	@AttributeDefinition(name = "Minuend-ID", description = "Component-IDs of the minuends; if empty '0' power is assumed")
	String[] minuends_ids();
	...
	@AttributeDefinition(name = "Minuends target filter", description = "This is auto-generated by 'Minuends-IDs'.")
	String minuends_target() default "(enabled=true)";
